...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image logo_32 = new Image(getClass().getClassLoader().getResource("images/logos/logo_32.png").toExternalForm());
        Image logo_64 = new Image(getClass().getClassLoader().getResource("images/logos/logo_64.png").toExternalForm());
        Image logo_128 = new Image(getClass().getClassLoader().getResource("images/logos/logo_128.png").toExternalForm());
