...
public class ShapeHandler {
    ...
    public void handleDrawCall() {
        ...
        switch (editorController.shapeToDraw) {
            ...
            case EditorController.TRIANGLE_POINT3:
                ...
                addToController = new be.ac.ulb.infof307.g09.controller.shape.Triangle(pt1, pt2, pt3, editorController.shapeThickness.getValue(), canvas.getIdForNewShape());
            ...
            case EditorController.CIRCLE:
                ...
                addToController = new be.ac.ulb.infof307.g09.controller.shape.Circle(new Coordinates(selectedX, selectedY), radius, editorController.shapeThickness.getValue(), canvas.getIdForNewShape());
                shape = circle;
                break;
            ...
            case EditorController.ARROW_POINT2:
                addToController = new be.ac.ulb.infof307.g09.controller.shape.Arrow(new Coordinates(previouslySelectedX, previouslySelectedY), new Coordinates(selectedX, selectedY), editorController.shapeThickness.getValue(), canvas.getIdForNewShape());
            ...
            case EditorController.LINE_POINT2:
                addToController = new be.ac.ulb.infof307.g09.controller.shape.Line(new Coordinates(previouslySelectedX, previouslySelectedY), new Coordinates(selectedX, selectedY), editorController.shapeThickness.getValue(), canvas.getIdForNewShape());
            ...
            case EditorController.SQUARE:
                ...
                addToController = new Square(new Coordinates(selectedX, selectedY), size, editorController.shapeThickness.getValue(), canvas.getIdForNewShape());
                break;
        }
    ...
    public Shape handleDraw(be.ac.ulb.infof307.g09.controller.shape.Shape shape) {
        ...
        if (shapeDrawing != null) {
            ...
            shapeDrawing.setStrokeWidth(shape.getThickness().thicknessValue());
