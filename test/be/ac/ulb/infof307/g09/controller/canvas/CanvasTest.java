...
public class CanvasTest {
    ...
    void setUp() {
        ...
        shape = new RectangleDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(50, 50), Thickness.THIN.toString(), id);
    }
    ...
    void updateShape_sameType() {
        canvas.addShape(shape);
        ShapeDTO newShape = new RectangleDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(0, 0), Thickness.VERY_THIN.toString(), id);
    ...
    void updateShape_differentType() {
        canvas.addShape(shape);
        ShapeDTO newShape = new CircleDTO(new CoordinatesDTO(0, 0), 50, Thickness.SEMI_THICK.toString(), id);
        assertEquals(shape, canvas.getShapeById(id));
    ...
    void getIdForNewShape_uniquenessGuaranteed() {
        canvas.addShape(new SquareDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(0, 0), Thickness.SEMI_THICK.toString(), canvas.getIdForNewShape()));
        canvas.addShape(new SquareDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(0, 0), Thickness.ULTRA_THICK.toString(), canvas.getIdForNewShape()));
    }
    ...
    void toTikz_expectedBehaviour() {
        ShapeDTO toAdd = new SquareDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(0, 0), Thickness.ULTRA_THIN.toString(), canvas.getIdForNewShape());
    ...
    void toTikz_multipleShapes() {
        ShapeDTO toAdd1 = new SquareDTO(new CoordinatesDTO(0, 0), new CoordinatesDTO(0, 0), Thickness.VERY_THICK.toString(), canvas.getIdForNewShape());
        ShapeDTO toAdd2 = new CircleDTO(new CoordinatesDTO(0, 0), 50, Thickness.VERY_THICK.toString(), canvas.getIdForNewShape());
    ...
    void copyToClipboard_expectedBehaviour() {
        ...
        ShapeDTO circle = new CircleDTO(new CoordinatesDTO(50, 50), 40, "THICK", id1);
        ShapeDTO line = new LineDTO(new CoordinatesDTO(100, 100), new CoordinatesDTO(500, 500), "THIN", id2);
