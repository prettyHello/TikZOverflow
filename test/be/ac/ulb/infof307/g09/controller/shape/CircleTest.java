...
class CircleTest {
    ...
    void print_simpleCircle() {
        Circle circle = new Circle(new Coordinates(1, 2), 3, Thickness.ULTRA_THIN, 1);
        assertEquals("\\draw[draw=black, ultra thin] (1.0,2.0) circle [radius=3.0] ;", circle.print());
    }

    @Test
    void print_complexCircle() {
        Circle circle = new Circle(true, true, Color.BLUE, Color.RED, Thickness.VERY_THICK, new Coordinates(1, 2), 3, 1);
    ...
    void constructor_NegativeRadius() {
        assertThrows(BizzException.class, () -> {
            new Circle(new Coordinates(1, 1), -1, Thickness.THIN, 1);
    ...
    void constructor_ZeroRadius() {
        assertThrows(BizzException.class, () -> {
            new Circle(new Coordinates(1, 1), 0, Thickness.THIN, 1);
