...
class RectangleTest {
    ...
    void print_SimpleRectangle() {
        Rectangle rectangle = new Rectangle(new Coordinates(0, 0), new Coordinates(1, 2), Thickness.ULTRA_THIN, 1);
        assertEquals("\\draw[draw=black, ultra thin] (0.0,0.0) rectangle (1.0,2.0) ;", rectangle.print());
    }

    @Test
    void print_ComplexRectangle() {
        Rectangle rectangle = new Rectangle(true, true, Color.BLUE, Color.RED, Thickness.VERY_THICK, new Coordinates(0, 0), new Coordinates(1, 2), 1);
