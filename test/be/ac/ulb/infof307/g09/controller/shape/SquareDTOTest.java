...
class SquareDTOTest {
    ...
    void print_SimpleSquare() {
        SquareDTO square = new SquareDTO(new CoordinatesDTO(0,0), new CoordinatesDTO(1,2), Thickness.THIN.toString(),1);
        assertEquals("\\draw[draw=black, thin] (0.0,0.0) rectangle (1.0,2.0) ;",square.print());
    }

    @Test
    void print_ComplexSquare() {
        SquareDTO square = new SquareDTO(new CoordinatesDTO(0,0),4,Thickness.THICK.toString(),1);
