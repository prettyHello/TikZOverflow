...
class CircleTest {
    ...
    void printSimpleCircle() {
        Circle circle = new Circle(new Coordinates(1,2),3);
    ...
    void printComplexCircle() {
        Circle circle = new Circle(true,true,Color.BLUE,Color.RED,new Coordinates(1,2),3);
    ...
    void constructorNegativeRadius() {
        assertThrows(BizzException.class, () -> {
            new Circle(new Coordinates(1,1),-1);
    ...
    void constructorZeroRadius() {
        assertThrows(BizzException.class, () -> {
            new Circle(new Coordinates(1,1),0);
