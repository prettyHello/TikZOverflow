...
class SquareTest {
    ...
    void printSimpleSquare() {
        Square square = new Square(new Coordinates(0,0), new Coordinates(1,2),Thickness.THIN.toString(),1);
        assertEquals("\\draw[draw=black, thin] (0.0,0.0) rectangle (1.0,2.0) ;",square.print());
    }

    @Test
    void printComplexRectangle() {
        Square square = new Square(new Coordinates(0,0),4,Thickness.THICK.toString(),1);
